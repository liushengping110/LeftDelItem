...
public class ItemStickyActivity extends AppCompatActivity implements SwipeItemClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_sticky);
        initUI();
        initData();
        setListener();
    }
    ...
    private SwipeMenuCreator mSwipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            if (viewType == GroupAdapter.VIEW_TYPE_NON_STICKY) {
                ...
                SwipeMenuItem closeItem = new SwipeMenuItem(ItemStickyActivity.this)
                ...
                SwipeMenuItem addItem = new SwipeMenuItem(ItemStickyActivity.this)
    ...
    private SwipeMenuItemClickListener mMenuItemClickListener = new SwipeMenuItemClickListener() {
        ...
        public void onItemClick(SwipeMenuBridge menuBridge) {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION) {
                Toast.makeText(ItemStickyActivity.this, "list第" + adapterPosition + "; 右侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
                switch (menuPosition){
                    case 0:
                        break;
                    case 1:
                ...
                Toast.makeText(ItemStickyActivity.this, "list第" + adapterPosition + "; 左侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
                switch (menuPosition){
                    case 0:
                        break;
                    case 1:
    ...
    public void onItemClick(View itemView, int position) {
        ...
        Toast.makeText(ItemStickyActivity.this,s,Toast.LENGTH_SHORT).show();
    }
    ...
    private static class GroupAdapter extends RecyclerView.Adapter<GroupViewHolder> {
        ...
        static final int VIEW_TYPE_STICKY = R.layout.list_item_itemsticky;
