...
public class ListActivity extends AppCompatActivity implements SwipeItemClickListener {
    ...
    public void onItemClick(View itemView, int position) {
        ...
        Toast.makeText(ListActivity.this,person.getName(),Toast.LENGTH_SHORT).show();
    }
}
