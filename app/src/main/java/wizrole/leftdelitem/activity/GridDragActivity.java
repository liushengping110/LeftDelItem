...
public class GridDragActivity extends AppCompatActivity{
    ...
    private OnItemMoveListener onItemMoveListener = new OnItemMoveListener() {
        ...
        public void onItemDismiss(int position) {
            ...
            Toast.makeText(GridDragActivity.this, "现在的第" + position + "条被删除。", Toast.LENGTH_SHORT).show();
        }
    };
...
//                当前状态：("状态：拖拽");
                ...
                viewHolder.itemView.setBackgroundColor(ContextCompat.getColor(GridDragActivity.this, R.color.white_pressed));
            } else if (actionState == OnItemStateChangedListener.ACTION_STATE_SWIPE) {
//                当前状态：("状态：滑动删除");
            } else if (actionState == OnItemStateChangedListener.ACTION_STATE_IDLE) {
//                当前状态：("状态：手指松开");
                // 在手松开的时候还原背景。
                ViewCompat.setBackground(viewHolder.itemView, ContextCompat.getDrawable(GridDragActivity.this, R.drawable.select_white));
            }
        }
    };
    ...
    public SwipeMenuCreator mSwipeMenuCreator = new SwipeMenuCreator() {
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            ...
            {
                SwipeMenuItem addItem = new SwipeMenuItem(GridDragActivity.this)
                ...
                SwipeMenuItem closeItem = new SwipeMenuItem(GridDragActivity.this)
            ...
            {
                SwipeMenuItem deleteItem = new SwipeMenuItem(GridDragActivity.this)
                        .setBackground(R.drawable.selector_red)
    ...
    private SwipeItemClickListener mItemClickListener = new SwipeItemClickListener() {
        ...
        public void onItemClick(View itemView, int position) {
            Toast.makeText(GridDragActivity.this, "第" + position + "个", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private SwipeMenuItemClickListener mMenuItemClickListener = new SwipeMenuItemClickListener() {
        ...
        public void onItemClick(SwipeMenuBridge menuBridge) {
            ...
            if (direction == SwipeMenuRecyclerView.RIGHT_DIRECTION) {
                Toast.makeText(GridDragActivity.this, "list第" + adapterPosition + "; 右侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            } else if (direction == SwipeMenuRecyclerView.LEFT_DIRECTION) {
                Toast.makeText(GridDragActivity.this, "list第" + adapterPosition + "; 左侧菜单第" + menuPosition, Toast.LENGTH_SHORT).show();
            }
        }
    };
